...
>1\. <ruby>子供<rp>(</rp><rt>こども</rt><rp>)</rp></ruby>たちは<u>カレーは</u><ruby>作<rp>(</rp><rt>つく</rt><rp>)</rp></ruby>っているが、<u>ごはんは</u>まだ<ruby>炊<rp>(</rp><rt>た</rt><rp>)</rp></ruby>いていない。<br>*The kids are making curry, but they haven't cooked the rice yet.*
...
Exclusive が is a special usage of が that **specifies** whatever it marks[^3]. The subject that exclusive が marks is singled out from a set of other possible things. Those other things may or may not be explicitly stated. In other words, everything else except for what exclusive が marks is **excluded** from consideration. 
...
All sentences with exclusive が take this general structure[^4], in which exclusive が marks the comment, and predicate refers to the topic. Sentences that use exclusive が are called **specificational sentences**.

[^4]: Except in the [｢かき料理は広島が本場だ。｣ structure](wa-ga-other#kaki) and [the selective-type of the ｢辞書は新しいのがいい。｣ structure](wa-ga-other#jisho). These are both double-subject structures.

> `Comment` + `Exclusive が` + `Topic`

You'll learn more about exclusive が when we go over the [specificational sentence structure](#spec-sentences) and the [Principle of Emphasis](/wa-ga-emphasis).
...
![Diagram showing topicalization of 父 in the case relation 父がこの本を買ってくれた(こと)](assets/img/chichi1.png)
...
![Diagram showing topicalization of この本 in the case relation 父がこの本を買ってくれた(こと)](assets/img/chichi2.png)
...
>16\. <u><ruby>神戸<rp>(</rp><rt>こうべ</rt><rp>)</rp></ruby>には</u><ruby>5時<rp>(</rp><rt>ごじ</rt><rp>)</rp></ruby>ごろ<ruby>選手<rp>(</rp><rt>せんしゅ</rt><rp>)</rp></ruby>たちが<ruby>着<rp>(</rp><rt>つ</rt><rp>)</rp></ruby>きます。<br>*To Kobe, the players will arrive around 5 'o clock.*
...
>28\. ｢<ruby>今朝<rp>(</rp><rt>けさ</rt><rp>)</rp></ruby>、お<ruby>袋<rp>(</rp><rt>ふくろ</rt><rp>)</rp></ruby>から<u><ruby>電話<rp>(</rp><rt>でんわ</rt><rp>)</rp></ruby>が</u>あったよ。｣<br>*"This morning, my mother called me."*
