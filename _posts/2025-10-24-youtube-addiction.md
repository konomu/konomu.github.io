...
![Some examples of my youtube history](/assets/img/ythistory.png)
...
1. The way the algorithm is so responsive to videos that you have recently watched.
2. Videos playing as a preview within the thumbnail, something that can't be disabled at all in the mobile app.
3. Its infinite scrolling nature and the recommended section (you never "run out" of videos).
4. Picture-in-picture (playing videos in the corner while you look at recommendations).
5. The gutting of features that encourage interpersonal interaction, like private messaging and video responses.
6. The algorithm's tendency to fixate on categories of videos that have mass appeal (movie/TV scenes, podcast content, clickbait).
...
- [DeArrow](https://dearrow.ajay.app/), an extension that removes clickbait thumbnails and video titles.
...
1. You must feel a visceral disgust with the algorithm and the design that makes youtube what it is. Realize how it has wronged you. Demand its apology.
2. Have in mind what you would like to do with the time you have, now free of the suffocating grasp of the algorithm. Maybe try writing it down. When you feel the urge to watch youtube, do it.
